...
public class StatisticRecentBooksAdapter extends RecyclerView.Adapter<StatisticViewHolder> {
    ...
    public StatisticRecentBooksAdapter(List<Book> books, OnItemListener onItemListener, List<Integer> frequency) {
        this.mBooks = books;
