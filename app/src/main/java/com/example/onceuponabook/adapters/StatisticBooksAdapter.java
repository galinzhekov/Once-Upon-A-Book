...
public class StatisticBooksAdapter extends RecyclerView.Adapter<StatisticViewHolder> {
    private List<BooksBought> mBooks;
    private List<Integer> mFrequency;
    private Context context;
    private static final String TAG = "CategoriesAdapter";
    private OnItemListener mOnItemListener;

    public StatisticBooksAdapter(List<BooksBought> books, OnItemListener onItemListener, List<Integer> frequency) {
        this.mBooks = books;
