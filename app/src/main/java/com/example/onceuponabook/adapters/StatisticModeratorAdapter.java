...
public class StatisticModeratorAdapter extends RecyclerView.Adapter<StatisticViewHolder> {
    private List<BooksAdded> mBooks;
    private List<Integer> mFrequency;
    private Context context;
    private static final String TAG = "CategoriesAdapter";
    private OnItemListener mOnItemListener;

    public StatisticModeratorAdapter(List<BooksAdded> books, OnItemListener onItemListener, List<Integer> frequency) {
        this.mBooks = books;
